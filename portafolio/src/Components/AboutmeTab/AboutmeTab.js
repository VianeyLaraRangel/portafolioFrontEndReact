        ...
        if (this.state.activeTab === 0) {
            ...
            return (
                <article>
                    ...
                    <h5>
                        Soy pasante de la licenciatura en Derecho en Ciudad Universitaria (UNAM SUA).
                        </h5>
                    <h5>Me considero <strong>empática, proactiva, analítica y persistente</strong>, siempre estoy dispuesta a ayudar a otrxs,
                          <strong> transmitir y recibir conocimiento</strong> por medio del intercambio de ideas
                          <br></br> 
                          ¡Me encanta!
                        </h5>
